...
# ============================================================================
"""Benchmark 2 regular graph maxcut for tensorflow quantum."""
import os
...
from benchmark.task_preparation.tf_2_regular_model import tf_qaoa_prepare
...
def test_2_regular_qaoa(platform: str, n_qubits: int):
    if platform in ["cpu", "gpu"]:
        run = tf_qaoa_prepare(platform, n_qubits)
    else:
        raise RuntimeError(
