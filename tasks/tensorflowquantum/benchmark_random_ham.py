...
# ============================================================================
"""Benchmark random hamiltonian expectation for tensorflow quantum."""
import os
...
from benchmark.task_preparation.tf_random_ham import tf_random_ham_prepare
...
def test_random_ham(platform: str, n_qubits: int):
    if platform in ["cpu", "gpu"]:
        run = tf_random_ham_prepare(platform, n_qubits)
    else:
