...
# ============================================================================
"""Benchmark random hamiltonian expectation for qulacs."""
import argparse

from benchmark import Benchmark
from benchmark.task_preparation.qulacs_random_ham import qulacs_random_ham_prepare
...
def test_random_ham(platform: str, n_qubits: int):
    if platform in ["cpu", "gpu"]:
        run = qulacs_random_ham_prepare(platform, n_qubits)
    else:
