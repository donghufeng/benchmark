...
# ============================================================================
"""Benchmark 4 regular graph maxcut for qulacs."""
import argparse

from benchmark import Benchmark
from benchmark.task_preparation.qulacs_4_regular_model import qulacs_qaoa_prepare
...
def test_4_regular_qaoa(platform: str, n_qubits: int):
    if platform in ["cpu", "gpu"]:
        run = qulacs_qaoa_prepare(platform, n_qubits)
    else:
        raise RuntimeError(
