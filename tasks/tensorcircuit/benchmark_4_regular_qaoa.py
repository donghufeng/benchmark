...
# ============================================================================
"""Benchmark 4 regular graph maxcut for tensorcircuit."""
import os
...
from benchmark.task_preparation.tc_4_regular_model import tc_qaoa_prepare
...
def test_4_regular_qaoa(platform: str, n_qubits: int):
    if platform in ["cpu", "gpu"]:
        run = tc_qaoa_prepare("tensorflow", platform, n_qubits)
    else:
        raise RuntimeError(
