...
# ============================================================================
"""Benchmark random circuit evolution for intel."""
import argparse

from benchmark import Benchmark
from benchmark.task_preparation.intel_random_circuit import intel_random_circuit_prepare
...
def test_random_circuit(n_qubits: int):
...
test_random_circuit(args.qubit)
