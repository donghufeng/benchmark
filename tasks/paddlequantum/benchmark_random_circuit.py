...
# ============================================================================
"""Benchmark random circuit evolution for paddle quantum."""
import argparse

from benchmark import Benchmark
from benchmark.task_preparation.paddle_random_circuit import (
    paddle_random_circuit_prepare,
)
...
def test_random_circuit(platform: str, n_qubits: int):
    if platform in ["cpu", "gpu"]:
        run = paddle_random_circuit_prepare(platform, n_qubits)
    else:
        raise RuntimeError(
