...
# ============================================================================
"""Benchmark random hamiltonian expectation for paddle quantum."""
import argparse

from benchmark import Benchmark
from benchmark.task_preparation.paddle_random_ham import paddle_random_ham_prepare
...
def test_random_ham(platform: str, n_qubits: int):
    if platform in ["cpu", "gpu"]:
        run = paddle_random_ham_prepare(platform, n_qubits)
    else:
