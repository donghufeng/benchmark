...
# ============================================================================
"""Benchmark random hamiltonian expectation for quest."""
import argparse

from benchmark import Benchmark
from benchmark.task_preparation.quest_random_ham import quest_random_ham_prepare
...
def test_random_ham(platform: str, n_qubits: int):
    if platform in ["cpu", "gpu"]:
        run = quest_random_ham_prepare(platform, n_qubits)
    else:
