...
# ============================================================================
"""Benchmark random hamiltonian expectation for mindquantum."""
import argparse

from benchmark import Benchmark
from benchmark.task_preparation.mq_random_ham import mq_random_ham_prepare
...
def test_random_ham(platform: str, n_qubits: int):
    if platform == "cpu":
        run = mq_random_ham_prepare("mqvector", n_qubits)
    elif platform == "gpu":
        run = mq_random_ham_prepare("mqvector_gpu", n_qubits)
    else:
