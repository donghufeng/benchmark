...
# ============================================================================
"""Benchmark 4 regular graph maxcut for mindquantum."""
import argparse

from benchmark import Benchmark
from benchmark.task_preparation.mq_4_regular_model import mq_qaoa_prepare
...
def test_4_regular_qaoa(platform: str, n_qubits: int):
    if platform == "cpu":
        run = mq_qaoa_prepare("mqvector", n_qubits)
    elif platform == "gpu":
        run = mq_qaoa_prepare("mqvector_gpu", n_qubits)
    else:
        raise RuntimeError(
