...
# ============================================================================
"""Benchmark random hamiltonian expectation for qiskit."""
import argparse

from benchmark import Benchmark
from benchmark.task_preparation.qiskit_random_ham import qiskit_random_ham_prepare
...
def test_random_ham(platform: str, n_qubits: int):
    if platform in ["cpu", "gpu"]:
        run = qiskit_random_ham_prepare(platform, n_qubits)
    else:
